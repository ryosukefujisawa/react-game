    ...
    useEffect(() => {
        const handleScoreSubmit = async () => {
            try {
              ...
              await axios.post('https://scores-game.mysql.database.azure.com/scores', { name: userName, score: userScore });
              
              /* フォームの入力をクリア */
              // setUserName('名無し');
              
              /* 最新のスコアリストを再取得して画面に反映 */
              const response = await axios.get<Score[]>('https://scores-game.mysql.database.azure.com/scores');
